...
var DashUser = require('mongoose').model('DashUsers'),
...
exports.signup = function(req, res, next) {
  ...
  if (!req.user) {
    ...
    var user = new DashUser(req.body);
    var message = null;
  ...
  DashUser.findOne({
    ...
    if (err) {
      ...
      if (!user) {
        ...
        DashUser.findUniqueUsername(possibleUsername, null, function(availableUsername) {
          // Configura el nombre de usuario disponible 
          profile.username = availableUsername;
          
          // Crear el user
          user = new DashUser(profile);
